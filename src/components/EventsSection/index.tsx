...
export default function EventsSection() {
  return (
    <section className="bg-secondary flex flex-col items-center justify-center gap-8 md:gap-12 md:py-20 py-12">
      ...
      {/* Aqui muda */}
      <div className="flex gap-4 px-4 md:px-12 overflow-x-auto md:overflow-visible snap-x snap-mandatory scrollbar-hide scroll-smooth md:grid md:grid-cols-4 md:gap-8">
